...
| `contract_session_projection` | `contract_session_projection.rs`, `session_projection/` | Session export, capture, enumeration, cursor custody, and canonical projection |
